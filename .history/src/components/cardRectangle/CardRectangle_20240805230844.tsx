    ...
    <div className={`${styles.card}`}>
      ...
      <div className={styles.cardContent}>
        ...
        <p className={styles.description}>
          ...
          cách hiệu quả mà còn thoát khỏi "tutorial hell" – tình trạng mà nhiều
          người học lập trình gặp phải khi chỉ biết làm theo các video hướng dẫn
          mà không hiểu rõ chức năng và lý do tại sao làm như vậy
        </p>
