...
const Hero = () => {
  return (
    <div className={`${styles.heroGrid} section`}>
      ...
      <div className={styles.data}>
        <h1 className={styles.welcome}>
          Welcome to <span className={styles.rimdsv}>Rimdasilva</span>{" "}
          <svg
            width="36"
            height="36"
            viewBox="0 0 48 48"
        ...
        <p className={styles.homeDescription}>
          Chào mừng đến với Rimdasilva Dev Blog ️🎧
        </p>
        <p className={styles.homeDescription}>
          Chia sẻ những kiến thức bổ ích về .NET và các công nghệ liên quan ✅
        </p>
        <p className={styles.homeDescription}>
          Bạn sẽ tìm thấy những bài viết, hướng dẫn chi tiết, và những mẹo vặt
          hữu ích, giúp bạn nắm vững các kỹ năng từ cơ bản đến nâng cao trong hệ
          sinh thái .NET. Hãy cùng chúng tôi khám phá và chinh phục thế giới lập
          trình đầy thú vị này ️🏅
        </p>
        <p></p>
      </div>
    </div>
